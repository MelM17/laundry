...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'customer.context_processors.notification_count',
                'launderer.context_processors.notification_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'laundrygo.wsgi.application'
